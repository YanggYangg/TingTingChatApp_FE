...
const ChatInfo = () => {
  ...
  if (!chatInfo) return <p>Đang tải thông tin chat...</p>;
    ...
    <div className="w-full bg-white p-2 rounded-lg h-screen flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="text-center my-4">
          <img
            src={chatInfo.avatar && chatInfo.avatar.trim() !== "" ? chatInfo.avatar : "https://cdn-media.sforum.vn/storage/app/media/wp-content/uploads/2023/12/anh-dai-dien-zalo-thumbnail.jpg"}
            className="w-20 h-20 rounded-full mx-auto"
          />
          <h2 className="text-lg font-semibold">{chatInfo.name}</h2>
        </div>
