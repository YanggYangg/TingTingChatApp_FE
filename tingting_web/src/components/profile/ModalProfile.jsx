    ...
    return (
        <><div className="absolute top-20 left-20 bg-gray-800 text-white rounded-lg shadow-lg w-64 p-4 z-50">
            ...
            <div className="flex flex-col space-y-2">
                <button className="text-left px-4 py-2 rounded hover:bg-gray-700 transition" onClick={() => setOpenModal("profile")}> Hồ sơ của bạn</button>
                <button className="text-left px-4 py-2 rounded hover:bg-gray-700 transition">Đổi mật khẩu</button>
                <button className="text-left px-4 py-2 rounded hover:bg-gray-700 transition text-red-400">Đăng xuất</button>
            </div>
