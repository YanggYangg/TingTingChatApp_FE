...
const CloudSocketContext = createContext<CloudSocketContextType>({ socket: null });

export const CloudSocketProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const socketInstance = io('http://192.168.1.28:3000', {
      query: { userId },
    });
